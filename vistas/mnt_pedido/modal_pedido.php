    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 id="modalPedidoabel">Agregar productos al pedido</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            
            <div class="modal-body">
                <!-- Campo oculto para edición -->
                <input type="hidden" id="id_pedido_edit" value="">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn_guardar_venta">Agregar a pedido</button>
            </div>
        </div>
    </div>
</div>