...
$(document).ready(function(){
    ...
    tabla=$('#tabla-proveedores').dataTable({
        ...
        "ajax":{
            url: '../../controladores/ProveedorControlador.php?opc=listar',
            type : "get",
            dataType : "json",
            error: function(e){
...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../controladores/ProveedorControlador.php?opc=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function editar(id_proveedor){
    $.post("../../controladores/ProveedorControlador.php?opc=mostrar",{id_proveedor:id_proveedor},function (data) {
        console.log(data);
...
function eliminar(id_proveedor){
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../../controladores/ProveedorControlador.php?opc=eliminar",{id_proveedor:id_proveedor},function (data) {
                $('#tabla-proveedores').DataTable().ajax.reload();	    
            });
            swal.fire(
                'Eliminado!',
